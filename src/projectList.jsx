	...
	<div>
		...
		<ul>
			...
			<ul>
				...
				<li><a href="#infrastructure-monitoring-system-ims-2024">Infrastructure Monitoring System (IMS, 2024)</a></li>
				<li><a href="#communication-modem-with-ethernet-le910v2-2024">Communication Modem with Ethernet (LE910V2, 2024)</a></li>
				<li><a href="#compact-data-collection-platform-v3-2024">Compact Data Collection Platform V3 (2024)</a></li>
				<li><a href="#temperature-controlled-ventilation-2024">Temperature controlled ventilation (2024)</a></li>
				<li><a href="#battery-monitoring-and-logging-pcb-2024">Battery Monitoring and Logging PCB (2024)</a></li>
				<li><a href="#lora-communication-daughter-board-for-cdcp-2024">LoRa Communication Daughter Board for CDCP (2024)</a></li>
				<li><a href="#4g-modem-for-ims-2024">4G Modem for IMS (2024)</a></li>
				<li><a href="#ims-front-panels-2024">IMS Front Panels (2024)</a></li>
				<li><a href="#satellite-communication-modem-2024">Satellite Communication Modem (2024)</a></li>
				<li><a href="#satellite-communication-daughter-board-for-cdcp-2024">Satellite Communication Daughter Board for CDCP (2024)</a></li>
				<li><a href="#signal-amplifier-and-conditioning-circuit-2024">Signal Amplifier and Conditioning Circuit (2024)</a></li>
				<li><a href="#radio-sonde-2023">Radio Sonde (2023)</a></li>
				...
				<li><a href="#automatic-meter-reading-2018">Automatic Meter Reading (2018)</a></li>
				<li><a href="#door-access-controller-2017">Door Access Controller (2017)</a></li>
				<li><a href="#rtdl-datalogger-2017">RTDL Datalogger (2017)</a></li>
				<li><a href="#infrastructure-monitoring-system-2017">Infrastructure Monitoring System (2017)</a></li>
				<li><a href="#communication-module-2017">Communication Module (2017)</a></li>
				<li><a href="#compact-data-collection-platform-cdcp-2016">Compact Data Collection Platform (CDCP, 2016)</a></li>
				<li><a href="#audio-remote-terminal-unit-artu-2016">Audio Remote Terminal Unit (ARTU, 2016)</a></li>
				<li><a href="#power-monitor-for-embedded-system-2016">Power monitor for Embedded System (2016)</a></li>
				<li><a href="#power-and-signal-interface-unit-2016">Power and Signal Interface Unit (2016)</a></li>
				<li><a href="#extension-board-for-odroid-c2-2016">Extension Board for Odroid-C2 (2016)</a></li>
				<li><a href="#anti-theft-movement-sensor-2016">Anti-theft Movement Sensor (2016)</a></li>
				<li><a href="#controller-system-for-weighing-2015">Controller system for weighing (2015)</a></li>
				<li><a href="#single-phase-energy-meter-2015">Single Phase Energy Meter (2015)</a></li>
				<li><a href="#relay-and-triac-controller-2015">Relay and Triac Controller (2015)</a></li>
				<li><a href="#power-supply-for-audio-amplifier-2015">Power Supply for Audio Amplifier (2015)</a></li>
				<li><a href="#power-supply-for-tele-terminal-2015">Power Supply for Tele-Terminal (2015)</a></li>
				<li><a href="#multipurpose-ethernet-board-2015">Multipurpose Ethernet Board (2015)</a></li>
				<li><a href="#lora-wireless-remote-terminal-unit-2015">LoRa Wireless Remote Terminal Unit (2015)</a></li>
				<li><a href="#vehicle-guard-and-fleet-management-2015">Vehicle Guard and Fleet Management (2015)</a></li>
			...
			<ul>
				...
				<li><a href="#acconeer-test-firmware-2023">Acconeer Test firmware (2023)</a></li>
				<li><a href="#rtk-system-2023">RTK system (2023)</a></li>
				<li><a href="#seismologger-2023">Seismologger (2023)</a></li>
				<li><a href="#radio-sonde-firmware-2023">Radio Sonde Firmware (2023)</a></li>
				<li><a href="#test-firmware-for-lr1121-lora-chipset-2023">Test firmware for LR1121 lora chipset (2023)</a></li>
				<li><a href="#test-firmware-for-piezo-pressure-sensor-2022">Test firmware for Piezo pressure sensor (2022)</a></li>
				<li><a href="#ble-keyboard-2020">BLE Keyboard (2020)</a></li>
				<li><a href="#sdi-12-converter-2019">SDI-12 Converter (2019)</a></li>
				<li><a href="#ups-monitoring-system-2019">UPS Monitoring System (2019)</a></li>
			...
			<ul>
				...
				<li><a href="#update-server-2023">Update server (2023)</a></li>
				<li><a href="#p-alert-integration-2023">P-Alert integration (2023)</a></li>
				<li><a href="#frontend-for-identity-and-access-management-cactus-2022">Frontend for Identity and Access Management (Cactus, 2022)</a></li>
				<li><a href="#api-gateway-2022">Api gateway (2022)</a></li>
				<li><a href="#identity-and-access-management-iam-2021">Identity and Access Management (IAM) (2021)</a></li>
				<li><a href="#contact-tracing-2020">Contact Tracing (2020)</a></li>
				<li><a href="#cdcp-testing-software-2019">CDCP Testing Software (2019)</a></li>
				<li><a href="#network-server-2017--2019">Network Server (2017 – 2019)</a></li>
				<li><a href="#customized-linux-kernel-for-embedded-system-2019">Customized Linux Kernel for Embedded System (2019)</a></li>
				<li><a href="#customized-bootloader-for-embedded-system-2019">Customized Bootloader for Embedded System (2019)</a></li>
				<li><a href="#lora-connector-for-network-server-2019">LoRa Connector for Network Server (2019)</a></li>
				<li><a href="#unixevents-2019">Unixevents (2019)</a></li>
				<li><a href="#ram-database-2018">RAM Database (2018)</a></li>
				<li><a href="#customized-mqtt-broker-2018">Customized MQTT Broker (2018)</a></li>
				<li><a href="#customized-lorawan-packet-forwarder-2017">Customized LoRaWAN Packet forwarder (2017)</a></li>
		...
		<ul class="projDesc">
			<li>It is an extension to the smart wheelchair (minor project). Furthermore, it equips with EEG probes, which captures signals from brain and processed to control the wheelchair.</li>
		</ul>

		<h3 id="university-minor-project-smart-wheelchair-2013" class="projTitle">University Minor Project (Smart Wheelchair, 2013)</h3>
		<ul class="projDesc">
		...
		<ul class="projDesc">
			<li>Developed firmware to evaluate BLE 5.4 performance in both Central and Peripheral roles, supporting 1M PHY, 2M PHY, and Coded PHY.</li>
		...
		<ul class="projDesc">
			...
			<li>Key functionalities include:</li>
			<div>
				<li>Base Mode: Receives RTK corrections and streams them to an NTRIP caster for external use.</li>
				<li>Rover Mode: Downloads RTK corrections from an NTRIP caster, processes the data, and pushes the corrected position data to a Time Series Software server.</li>
				<li>Orientation Detection: Utilized a digital accelerometer via SPI to detect the device’s orientation, enabling dynamic adjustments to RTK data.</li>
		...
		<ul class="projDesc">
			...
			<li>Designed and implemented a data pipeline that converts ADC readings into Mini-SEED format, encapsulates them in Datalink protocol, and transmits them over TCP to a Ring server.</li>
			<li>Engineered a fault-tolerant data buffering system with 8MB RAM for temporary storage, ensuring data integrity during connectivity failures.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented Core 0 for managing radio operations, including initialization, configuration, data transmission, and reception, using STM32’s Sequencer for optimized interrupt-based execution.</li>
			<li>Utilized Core 1 to acquire GPS data, temperature, and humidity readings from an analog processor, process and pack the data, then trigger Core 0 for transmission.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented a GPS-time synchronization mechanism to ensure all devices share the same configuration at a given time, with configuration changes occurring every 5 seconds.</li>
			<li>Designed multiple operation modes, including Loopback mode, where the receiver sends back the same message to the transmitter, and a chat-like message sending mode for user interaction.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented signal processing to detect the sensor’s response frequency, which varies with pressure.</li>
		...
		<ul class="projDesc">
			...
			<li>Interfaced the system with a PS2 keyboard, using the PS2 protocol to read and process keystrokes.</li>
		...
		<ul class="projDesc">
			...
			<li>Configured the server to deliver accurate correction data from reference stations to GNSS receivers, enabling high-precision positioning in real-time.</li>
		...
		<ul class="projDesc">
			...
			<li>Integrated with Identity and Access Management (IAM) systems to handle authentication and authorization flows securely.</li>
		...
		<ul class="projDesc">
			...
			<li>Developed a custom rule-based policy engine enabling granular access control per user, endpoint, method, and role – allowing dynamic enforcement of security and authorization rules.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented authentication protocols.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented Bluetooth-based proximity detection to record close contacts and alert users in case of exposure to an infected individual.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented testing modules to assess the performance of sensors, interfaces, and communication protocols to ensure proper operation.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented reliable communication protocols to support real-time data transmission and synchronization among devices.</li>
		...
		<ul class="projDesc">
			...
			<li>Developed and tailored a custom Linux kernel for an embedded system based on the NXP i.MX6SX SoC, featuring a heterogeneous dual-core architecture (ARM Cortex-A9 + Cortex-M4).</li>
			<li>Key contributions include:</li>
			<ul class="projDesc">
				<li>Kernel Configuration and Optimization.</li>
				<li>Device Tree Customization.</li>
				<li>U-Boot &amp; Bootloader Integration.</li>
				<li>M4 Firmware Co-existence.</li>
				<li>Peripheral Driver Development.</li>
		...
		<ul class="projDesc">
			...
			<li>Forked and customized the open-source Das U-Boot bootloader from the Freescale repository to meet specific device requirements.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented seamless data exchange by translating LoRaWAN messages into a format compatible with the network server, ensuring smooth communication.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented efficient message exchange and event-based communication, ensuring smooth interaction between distributed applications.</li>
		...
		<ul class="projDesc">
			...
			<li>Implemented efficient data structures for fast lookups, ensuring quick access to routing information and reducing server latency.</li>
		...
		<ul class="projDesc">
			...
			<li>Added new features and optimizations to enhance performance, security, and scalability beyond the default MQTT specifications.</li>
		...
		<ul class="projDesc">
			...
			<li>Designed specifically for the Department of Hydrology and Meteorology, enabling timely distribution of critical weather and flood alerts to the public.</li>
		...
		<ul class="projDesc">
			<li>Designed 3D-printable enclosures for an infrastructure monitoring system, optimized for rapid prototyping and validation.</li>
			<li>Created detailed 3D CAD models and engineering drawings, ensuring accurate fit with PCBs, sensors, and connectors.</li>
			<li>Iterated enclosure prototypes using FDM 3D printing, validating tolerances, assembly, and ergonomics before production tooling.</li>
		...
		<ul class="projDesc">
			...
			<li>It has a cutouts for 3 buttons, display, 2 temperature sensor and AC input and output connectors.</li>
			<li>It has a flange to mount it on a wall.</li>
		</ul>
